...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("slowLog.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_slowLog_globals, slowLog_globals)
    STD_PHP_INI_ENTRY("slowLog.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_slowLog_globals, slowLog_globals)
PHP_INI_END()
*/
/* }}} */
